    ...
    <main class="pb-5">
        ...
        <section class="welcome py-4 px-2">
            <div class="container pt-5">
                <p class="">ضمن خیر مقدم خدمت کاربران جدید، لطفا ثبت نام کنید تا قابلیت هایی چون <a href="userUpload.php">ثبت سفارش</a> و <a href="#">پیگیری سفارش</a> برایتان فراهم شود.</p>
