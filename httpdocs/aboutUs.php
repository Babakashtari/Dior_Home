    ...
    <main>
        ...
        <section class="description my-5">
            <div class="col-10 mx-auto bg-light text-dark text-center border border-primary my-4 iranSans">
                ...
                <ul class="px-2">
                    <li>
                        <h4 class="text-justify">تاریخچه:</h4>
                    ...
                    <li>
                        <h4 class="text-justify">کارخانه چاپ:</h4>
                        <p class="text-justify">
                    ...
                    <li>
                        ...
                        <ul class="px-sm-5">
                            ...
                            <li>
                                <p class="text-justify">کادر مجرب  کارخانه پیشگامان پودینه با توجه به نوع و کاربرد محصول چاپی، مناسب ترین پارچه را جهت چاپ گزینش می کنند و بدین ترتیب چاپ پیشگامان پودینه آتا دارای کمترین پساب رنگ و بیشترین ماندگاری است. پالت و تیوب های رنگی مصرفی در شرکت پیشگامان پودینه آتا همگی سوئیسی و آلمانی بوده که بهترین کیفیت را دارند و همچنین پارچه های تولید شده، پس از چاپ برای ثبات هر چه بیشتر رنگ قبل از تحویل در استخر آب داغ شسته می شوند.</p>
                            </li>
                            <li>
