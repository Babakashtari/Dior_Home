    ...
    <main>
        <section>
            <div class="col-10 mx-auto bg-light text-dark text-center border border-primary my-4 iranSans">
                ...
                <p class="text-justify">شركت پيشگامان پودينه آتا مفتخر است كه با بيش از 30 سال تجربه در حوزه توليد و فروش عمده پارچه خدمت رسان شركت ها و تولیدی های عمده فروشی در سطح کل کشور است.</p>
            </div>
        </section>
        <?php show_warning(); ?>
    </main>
