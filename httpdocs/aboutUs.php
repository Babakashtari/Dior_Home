            ...
            <div class="col-10 mx-auto bg-light text-dark text-center border border-primary my-4 iranSans">
                ...
                <ul class="px-2">
                    ...
                    <li>
                        ...
                        <p class="text-justify">
                            کارخانه چاپ دیجیتال پیشگامان پودینه آتا به شکل امروزی آن ابتدا در سال ۱۳۹۷ توسط جمعی از مهندسین و متخصصین صنعت چاپ و همكاری بازاریان با شماره ثبت ۱۴۴۵۳ و تحت مدیریت آقایان علی میر حیدری و عطائی در اردبیل تاسیس شد. کارخانه پیشگامان پودینه آتا در اردبیل، ميدان ايثار، شهرک صنعتی فاز ۱، خيابان پنجم شرقی واقع شده است. 
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="px-sm-5">
                            ...
                            <li>
                                <p class="text-justify">پیشگامان پودینه ۴ دستگاه صنعتی پرس حرارتی، ۲ دستگاه پرینت سابلیمیشن و بیش از ۵۰ نفر نیروی متخصص دارد که قادر اند به طور متوسط روزانه بیش از ۵۰۰۰ متر پارچه طرحدار تولید کنند.</p>
                            </li>
