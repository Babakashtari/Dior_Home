    ...
    function validator(){
        ...
        if(isset($_POST['submit'])){  
            ...
            if(!empty($_FILES['uploadingfile']) && !empty($_POST['file_name']) && !empty($_POST['category']) && !empty($_POST['subcategory'])){
                ...
                if(!empty($user_inserted_name) && !empty($category) && !empty($sub_category) && is_uploaded_file($file_TMP_name) && (empty($_POST['dimensions']) || (!empty($_POST['dimension']) && !empty($file_dimension))) && (empty($_POST['description']) || (!empty($_POST['description']) && !empty($text_area)))){
