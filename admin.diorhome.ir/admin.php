    ...
    <main class=" row d-flex justify-content-center align-items-center">
        <section class="col-7 col-sm-6 col-md-5 col-lg-4 col-xl-3">
            ...
            <form class="pb-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="password" id="password" placeholder="رمز عبور" oninput="validate(/^[a-zA-Z0-9]{5,15}$/, this)">
            ...
            <div class="link-container iranSans row text-right py-2">
                <a href="../forgot.php" class="col-12 text-center">رمز عبورم را فراموش کرده ام</a>
                <a href="../index.php" class="col-12 text-center">برو به صفحه اصلی</a>
                <a href="../login.php" class="col-12 text-center">کاربر عادی هستم</a>
            </div>
        </section>
    </main>
