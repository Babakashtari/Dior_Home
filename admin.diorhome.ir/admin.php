...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="../httpdocs/apple-icon-57x57.png">
    ...
    <main class=" row d-flex justify-content-center align-items-center">
        <section class="col-7 col-sm-6 col-md-5 col-lg-4 col-xl-3">
            <div class="text-center py-1 pt-3">
                <img src="../httpdocs/images/Dior_logo.jpg" alt="لوگوی پیشگامان پودینه">
            </div>
            ...
            <div class="link-container iranSans row text-right py-2">
                <a href="../httpdocs/forgot.php" class="col-12 text-center">رمز عبورم را فراموش کرده ام</a>
                <a href="../httpdocs/index.php" class="col-12 text-center">برو به صفحه اصلی</a>
                <a href="../httpdocs/login.php" class="col-12 text-center">کاربر عادی هستم</a>
            </div>
        </section>
    </main>
