...
const selects_errors = document.querySelectorAll("main>section.file-upoad>fieldset>form>div.form-group>select+p");

console.log(selects);
console.log(inputs);

const subcategory_generator = main_category => {
  select_validate(/^(کوسن|روبالشی|روتختی|ملافه|پرده|رومبلی|رومیزی|فرش|روفرشی|تابلوفرش)$/, category_selector);
